...
SetBorderColor(0,0,0)
 ...
 //ЗАГРУЗКА ФАЙЛОВ
 //здесь я загружаю тайл стены, он должен находиться в папке "media":
 ...
 //САМОЕ ИНТЕРЕСНОЕ
 OpenToRead(1,"map.txt")	 //* Открыл файл, в файле строка "1,0,1,0,1", файл map.txt находится в папке media
 ...
 //А ТУТ БУДЕТ ВЕЛИКОЛЕПНАЯ ПО ПРОСТОТЕ ЗАГРУЗКА УРОВНЯ ИЗ ВЗЯТОГО ВЫШЕ ФАЙЛА!
 If tile = 1 then SetSpritePosition(wall, 0,0) // пока здесь полная херня
//Петля:
Do
